...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Lavender candle', 'Vixen', 22, FALSE),
('Clear Quartz', 'Frosty the Snowman', 7, FALSE),
('Palo Santo', 'Heat Miser', 4, TRUE),
('Mini ice ball tray' 'Snow Miser', 16, TRUE),
('Paid Glamping trip', 'Mrs. C' 100, FALSE);
--
